...
for(var c=0;c<5;c++)
{
  balls.push(new Ball(random(50,300),random(-1000,10),10,20));
}
...
function draw()
{
    ...
    //  posx+=5;
    //  posy-=5;
      if(balls[a].body.position.y>900)
      {
        console.log("increase "+balls[a]+" "+balls[a].body.position.x);
        Matter.Body.setVelocity(balls[a].body,{x:6,y:-50});
      }
